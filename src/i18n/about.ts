...
export const aboutContent = {
  ...
  "pt-br": {
    ...
    story: {
      ...
      paragraphs: [
        "Oi! Meu nome é Danielle e sou uma artista digital. Desenho no papel desde criança e cresci com um amor pela arte. Seja ela feita a mão, usando massas de modelar, esculturas, com fita ou papelão, o que for preciso para fazer as minhas ideias artísticas ganharem vida.",
        "Sempre desenhei na boa e velha maneira tradicional, mas em 2021 eu finalmente consegui a minha primeira mesa digitalizadora com display pois era a que eu queria para poder ver enquanto desenhava. Fui praticando durante os anos até encontrar o meu próprio estilo e sempre melhorar, hoje estou muito feliz com todo o progresso que consegui criar com a minha arte e o estado atual dela.",
        "Amo o meu estilo mas estou sempre em busca de ir além. No momento estou levando meus desenhos muito mais a sério buscando estudar e me aperfeiçoar, principalmente com a pintura e construção de cenários. Sinto que ainda tenho muito a aprender e estou bem ansiosa em conquistar novos patamares com meu desenho. Espero que gostem da minha arte assim como eu gosto.",
